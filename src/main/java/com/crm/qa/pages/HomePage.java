...
public class HomePage extends TestBase {
	...
	public void gettingSpanishText() throws InterruptedException {
		...
		Thread.sleep(2000);
		Assert.assertEquals(targetTextDemocracias.getText(),"Democracias","Democracia text is not presented on Target field side");
		Thread.sleep(3000);
	}
	public void swappingTheLanguage() throws InterruptedException {
		...
		Assert.assertEquals(targetTextDemokratieNew.getText(), "Demokratien","Demokratie text is not presented on Target field side.");
		Thread.sleep(2000);
	}
